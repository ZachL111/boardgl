...
boardgl is a TypeScript project for graphics. It focuses on this technical goal: Map FEN positions to board coordinates and legal-square overlays.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 173, risk penalty 5, latency penalty 4, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
