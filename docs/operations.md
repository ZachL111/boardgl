...
`boardgl` is centered on graphics work in TypeScript. The technical target is: Map FEN positions to board coordinates and legal-square overlays.
...
The score is deterministic. The current threshold is 173. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 6.
