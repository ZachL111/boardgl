"""Regression checks for the boardgl casebook."""
...
from casebook.harness import assert_expected, boardgl_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(boardgl_summary(), assert_expected())
